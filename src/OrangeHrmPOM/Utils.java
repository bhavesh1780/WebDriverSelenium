...
import static OrangeHrmPOM.BasePage.driver;
...
public class Utils {
    ...
    public static void sleep(int i){
        ...
        } catch (InterruptedException e) {    //Thres.sleep producing IntrruptedException and we are handling it by using try and catch
            e.printStackTrace();
        }
    }
